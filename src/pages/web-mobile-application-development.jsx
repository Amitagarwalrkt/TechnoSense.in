  ...
  <div role="main" className="main">
    <div className="inner-page-hero">
      <div className="container">
        ...
        <h1 className="inner-page-title">Web Applications Development ├óΓé¼ΓÇ£ Open <span>Source</span></h1>
        <p className="inner-page-desc">Modern web and mobile application development with open-source excellence.</p>
      </div>
    </div>
        ...
        <div className="col">
          <div className="overflow-hidden mb-3">
            <h2 className="word-rotator slide font-weight-bold text-8 mb-0 appear-animation" data-appear-animation="maskUp">
              <span>Web Applications Development ├óΓé¼ΓÇ£ Open Source</span>
            </h2>
          </div>
        </div>
      </div>
      <div className="row">
        <div className="col-md-12">
          <p className="text-justify mb-2">
            We build powerful, secure, and scalable web applications using modern open-source technologies. Our development approach focuses on performance, clean architecture, and seamless user experience. By leveraging leading open-source frameworks, we create cost-effective solutions that can grow with your business.
          </p>
          <p className="text-justify mb-2">
            Our team has deep expertise across frontend, backend, and full-stack development, enabling us to deliver custom web applications that meet business requirements while reducing development and maintenance costs.
          </p>
          <h4 className="mb-2 mt-4">Technologies We Work With</h4>
          <h5 className="mb-2 mt-3">Angular &amp; Modern JavaScript Frameworks</h5>
          <p className="text-justify mb-2">
            We develop responsive, interactive, and high-performance frontends using Angular and other modern UI frameworks. Our solutions help enterprises deliver fast, user-friendly web experiences across devices.
          </p>
          <h5 className="mb-2 mt-3">Java (Open Source Stack)</h5>
          <p className="text-justify mb-2">
            Using open-source Java frameworks like Spring and Hibernate, we build secure, reliable, and scalable enterprise applications that support complex business processes.
          </p>
          <h5 className="mb-2 mt-3">PHP</h5>
          <p className="text-justify mb-2">
            We create dynamic, database-driven applications using PHP-based frameworks such as Laravel, CodeIgniter, and WordPress, ensuring flexibility and fast development cycles.
          </p>
          <h5 className="mb-2 mt-3">.NET (Cross-Platform via .NET Core)</h5>
          <p className="text-justify mb-2">
            We leverage .NET Core, the open-source, cross-platform version of .NET, to build modern, high-performance web applications.
          </p>
          <h4 className="mb-2 mt-4">Services We Provide</h4>
          <ul className="mb-2">
            <li>Custom Web Application Development</li>
            <li>Mobile-Friendly Web App Development</li>
            <li>Enterprise Portals &amp; Dashboard Development</li>
            <li>API Development &amp; Integration</li>
            <li>Chatbot-enabled Web Applications</li>
            <li>Frontend &amp; Backend Development</li>
            <li>Support, Maintenance &amp; Scaling</li>
          </ul>
        </div>
      </div>
    </div>
