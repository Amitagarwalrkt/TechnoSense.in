  ...
  <div role="main" className="main">
    <div className="inner-page-hero">
      <div className="container">
        ...
        <h1 className="inner-page-title">Cloud Consulting <span>Solutions</span></h1>
        <p className="inner-page-desc">Enterprise cloud strategy, deployment, and modernization tailored to your business goals.</p>
      </div>
    </div>
        ...
        <div className="col-md-7">
          <div className="overflow-hidden mb-3">
            <h2 className="word-rotator slide font-weight-bold text-8 mb-0 appear-animation" data-appear-animation="maskUp">
              <span>Cloud Consulting Solutions</span>
            </h2>
          </div>
          <p className="text-justify mb-2">
            Technosense is one the pioneer companies in India to adopt cloud solutions and with our rich
            experience wehelp you design, develop and deliver transformational cloud solutions to drive
            your businesses forward.</p>
          <ol className="services_anchor">
            <li><a href="/cloud-adoption-strategy">Cloud strategy consulting</a></li>
            <li><a href="/implementation-migration">Cloud Deployment &amp; migration services</a></li>
