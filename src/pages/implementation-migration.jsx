export default function ImplementationMigration() {
  return (
<div className="body">
  {/* Modern Navbar */}
  ...
  <div role="main" className="main">
    <div className="inner-page-hero">
      <div className="container">
        ...
        <h1 className="inner-page-title">Cloud Implementation &amp; <span>Migration</span></h1>
        <p className="inner-page-desc">Seamless migration and implementation services that keep your systems secure and operational.</p>
      </div>
    </div>
    <div className="container pb-1 inner-page-card">
        ...
        <div className="col">
          <div className="overflow-hidden mb-3">
            <h2 className="word-rotator slide font-weight-bold text-8 mb-0 appear-animation" data-appear-animation="maskUp">
              <span>Cloud Implementation &amp; Migration </span>
            </h2>
          </div>
        </div>
      </div>
      <div className="row">
        <div className="col-md-7">
          <p className="text-justify mb-2">We create customized, and tailor made solutions fitting your specifics needs of the organization and ensuring smooth transition from your on prem to cloud transformation journey.</p>
          <h5 className="mb-1">We can help you with:</h5>
          <ul>
            <li>Deploy sustainable and scalable cloud solutions meeting your business needs.</li>
            <li>We ensure fast and accurate deployments to get you live in minimum time.</li>
            <li>Migration of on prem solutions to cloud.</li>
            <li>Strong documentation &amp; Manuals ensuring your staff finds it seamless.</li> 
            <li>Robust support &amp; maintenance mechanisms to ensure close to zero downtime.</li>
          </ul>    
        </div>
