export default function NetworkSecurityCompliances() {
  return (
<div className="body">
  {/* Modern Navbar */}
  ...
  <div role="main" className="main">
    <div className="inner-page-hero">
      <div className="container">
        ...
        <h1 className="inner-page-title">Network Security &amp; <span>Compliances</span></h1>
        <p className="inner-page-desc">Strengthen security posture and meet compliance requirements with proven controls.</p>
      </div>
    </div>
        ...
        <div className="col">
          <div className="overflow-hidden mb-3">
            <h2 className="word-rotator slide font-weight-bold text-8 mb-0 appear-animation" data-appear-animation="maskUp">
              <span>Network Security &amp; Compliances</span>
            </h2>
          </div>
        </div>
      </div>
      <div className="row">
        <div className="col-md-12">
          <p className="text-justify mb-2">
            We provide strong network security solutions that protect your organization from cyber threats and ensure compliance with industry standards. Our team secures your entire IT environment-networks, servers, devices, applications, and data-so your business remains safe, reliable, and fully compliant.
          </p>
          <p className="text-justify mb-2">
            We follow a proactive security approach by continuously monitoring systems, identifying vulnerabilities, and implementing the right controls to prevent attacks before they occur. With our compliance-driven practices, your business stays aligned with regulatory requirements and industry guidelines.
          </p>
          <h4 className="mb-2 mt-4">Services We Provide</h4>
          <h5 className="mb-2 mt-3">Firewall &amp; Network Protection</h5>
          <p className="text-justify mb-2">
            Deployment and management of firewalls, IDS/IPS, and advanced threat protection systems to secure your network from internal and external attacks.
          </p>
          <h5 className="mb-2 mt-3">Compliance Management</h5>
          <p className="text-justify mb-2">
            Ensuring your IT environment meets required standards such as ISO, GDPR, PCI-DSS, and other regulatory frameworks through proper policies, documentation, and audits.
          </p>
          <h5 className="mb-2 mt-3">Vulnerability Assessment</h5>
          <p className="text-justify mb-2">
            Regular scanning and assessment of your systems to detect weaknesses and recommend corrective actions to strengthen security.
          </p>
          <h5 className="mb-2 mt-3">Endpoint &amp; Device Security</h5>
          <p className="text-justify mb-2">
            Protecting laptops, mobiles, and connected devices with advanced security tools, monitoring, and access control policies.
          </p>
          <h5 className="mb-2 mt-3">Data Security &amp; Encryption</h5>
          <p className="text-justify mb-2">
            Securing sensitive business data through encryption, access controls, and backup strategies to prevent unauthorized access or loss.
          </p>
        </div>
      </div>
    </div>
