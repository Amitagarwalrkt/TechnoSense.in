export default function MicrosoftO365() {
  return (
<div className="body">
  {/* Modern Navbar */}
  ...
  <div role="main" className="main">
    <div className="inner-page-hero">
      <div className="container">
        ...
        <h1 className="inner-page-title">Microsoft O365 <span>Services</span></h1>
        <p className="inner-page-desc">Complete Microsoft 365 services for productivity, collaboration, and security.</p>
      </div>
    </div>
    <div className="container pb-1 inner-page-card">
      <div className="row">
        <div className="col-md-7">
          <div className="overflow-hidden mb-3">
            <h2 className="word-rotator slide font-weight-bold text-8 mb-0 appear-animation" data-appear-animation="maskUp">
              <span>Microsoft O365 Services</span>
            </h2>
          </div>
          <p className="text-justify mb-2">
            At TechnoSense NextGen Solutions, we provide comprehensive Microsoft Office 365 services that help businesses maximize productivity, enhance collaboration, and secure their digital workplace. Our team brings extensive expertise in Microsoft 365 deployment, configuration, security, and management, enabling organizations to leverage the full power of Microsoft's cloud-based productivity suite.
          </p>
          <p className="text-justify mb-2">
            We specialize in Office 365 licensing, setup, migration, security configuration, and mobile device management. Our services cover the entire O365 lifecycle-from selecting the right licenses and setting up your tenant to implementing advanced security controls, managing mobile devices, and ensuring compliance with industry standards. By following Microsoft best practices and security guidelines, we ensure your O365 environment is optimized for productivity while maintaining the highest levels of security and compliance.
          </p>
          <p className="text-justify mb-2">
            Whether you're migrating from on-premises Exchange, setting up O365 for the first time, or need to enhance security and device management, our team provides end-to-end solutions tailored to your business needs. We help organizations transform their workplace with secure, cloud-based collaboration tools that enable teams to work efficiently from anywhere.
          </p>
          <ol className="services_anchor">
            <li><a href="/O365-licensing-setup">O365 Licensing &amp; Setup</a></li>
            <li><a href="/security-solutions">Security Solutions</a></li>
        ...
        <div className="col-md-5">
          <img src="technosense/micro-365.png" alt />
        </div>
      </div>
    </div>
  </div>
