  ...
  <div role="main" className="main">
    <div className="inner-page-hero">
      <div className="container">
        ...
        <h1 className="inner-page-title">Development <span>Services</span></h1>
        <p className="inner-page-desc">Custom application development that turns complex requirements into scalable digital products.</p>
      </div>
    </div>
    <div className="container pb-1 inner-page-card">
      ...
      <div className="row">
        <div className="col-md-7">
          <p className="text-justify mb-2">As Application development is an inherent part of our technology solution offerings, We provide the complete range of Oracle developmental packages including Java Cloud, Oracle Apex Cloud, and visual force ├óΓé¼ΓÇ£enabling you to reduce the complexity and cost of traditional solutions.
            We use Oracle ADF, Magic XPa Platforms as well as open source platforms like JAVA, .Net and PHP for various application development service that adds great value in terms of keeping your requirements and business up to date. 
          </p>
          <h5 className="mb-1">We can help you with:</h5>
          <ol className="services_anchor">
            <li><a href="/website-development">Website Development</a></li>
            <li><a href="/mobile-app-development">Mobile App Development</a></li>
            <li><a href="/oracle-apex">Oracle ADF, ApEx</a></li>
            <li><a href="/web-mobile-application-development">Web Application Development ├óΓé¼ΓÇ£ Open Source</a></li>
            <li><a href="/maf-mcs-cloud">Enterprise Mobility Solutions - MAF, MCS and Open Source - Java, Dot Net PHP</a></li>
          </ol>    
        </div>
        <div className="col-md-5">
          <img src="technosense/development-services.png" alt />
        </div>
      </div>
    </div>
  </div>
