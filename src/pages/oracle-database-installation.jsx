    ...
    <div className="container pb-1 inner-page-card">
      ...
      <div className="row">
        <div className="col-md-12">
          ...
          <p className="text-justify mb-2">
            Implementing Real Application Clusters (RAC), Data Guard, and other Oracle technologies to ensure 24├âΓÇö7 uptime.
          </p>
          ...
          <p className="text-justify mb-2">
            24├âΓÇö7 monitoring, health checks, issue resolution, and preventive maintenance to keep your Oracle databases running smoothly.
          </p>
        </div>
      </div>
    </div>
