export default function ItInfraRoadmapConsulting() {
  return (
<div className="body">
  {/* Modern Navbar */}
  ...
  <div role="main" className="main">
    <div className="inner-page-hero">
      <div className="container">
        ...
        <h1 className="inner-page-title">IT &amp; Infra Roadmap <span>Consulting</span></h1>
        <p className="inner-page-desc">Strategic roadmap consulting that aligns technology investments with business outcomes.</p>
      </div>
    </div>
    <div className="container pb-1 inner-page-card">
        ...
        <div className="col">
          <div className="overflow-hidden mb-3">
            <h2 className="word-rotator slide font-weight-bold text-8 mb-0 appear-animation" data-appear-animation="maskUp">
              <span>Infrastructure Management Services</span>
            </h2>
          </div>
        </div>
      </div>
      <div className="row">
        <div className="col-md-12">
          <h4>Revamp the IT infra management experience to proactively assist clients even before they become aware of any issues.</h4>
          <p className="text-justify mb-2">
            With an experienced team serving prominent global clients, we possess an in-depth understanding of every aspect of infrastructure and the interconnections necessary for seamless business operations. Our managed IT infrastructure services encompass network and storage management, device monitoring and management, and the ongoing support and maintenance of critical software and applications that facilitate team collaboration and business continuity.</p>
          <p className="text-justify mb-2">
            By outsourcing infrastructure management services to us, you can focus on their core business activities while ensuring that their IT infrastructure remains secure, reliable, and optimized for performance.
          </p>
          <h4 className="mb-2">Services We Perform:</h4>
          <ul>
            <li><strong> Network &amp; Server Management :</strong> Provisioning, monitoring, and maintaining server hardware and software to ensure uptime, performance, and security.</li>
            <li><strong>Database Management :</strong> Installing, configuring, and managing database systems, such as MySQL, Oracle, and SQL Server, to ensure efficient data storage, retrieval, and security.</li>
            <li><strong>Cloud &amp; Security Management :</strong> Managing cloud infrastructure and services, including public, private, and hybrid clouds, to ensure cost-effective, scalable, and secure cloud deployments.Implementing and managing security measures, such as firewalls, intrusion detection systems, and antivirus software, to protect against cyber threats and ensure compliance with regulatory requirements.</li>
            <li><strong>Incident and Problem Management :</strong> Responding to and resolving IT incidents and problems, including troubleshooting, root cause analysis, and implementing corrective actions to prevent recurrence.</li>
          </ul>
        </div>
      </div>
    </div>
