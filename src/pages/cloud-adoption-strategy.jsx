  ...
  <div role="main" className="main">
    <div className="inner-page-hero">
      <div className="container">
        ...
        <h1 className="inner-page-title">Cloud Strategy <span>Consulting</span></h1>
        <p className="inner-page-desc">Build a clear cloud adoption roadmap that reduces risk and accelerates digital transformation.</p>
      </div>
    </div>
      ...
      <div className="row">
        <div className="col-md-7">
          <p className="text-justify mb-2">
            Technosense works closely with its clients in developing the right fit strategy suiting the business, and construct a concrete roadmap towards its digitization and cloud adoption and implementation journey.</p>
          <h5 className="mb-1">We can help you with:</h5>
          <ul>
            <li>Transforming your business via consulting and helping you adopt best in class cloud based productivity, monitoring and collaboration solutions optimised with your devices.</li>
            <li>Select high performance, low cost cloud solutions keeping your future expansion plans in picture.</li>
            <li>Developing a roadmap that syncs with your manpower and present infra and setups with minimum investment and max ROI.</li>
          </ul>    
        </div>
